...
app.post('/dreamhouse',requestVerifier, (req, res) => {
    ...
    if (type === 'LaunchRequest') {
        ...
        response.say("Welcome to Cumulus Mortgage Demo. What would you like to know? You can ask me questions like Alexa ask Cumulus mortgage for what is for sale","false");
